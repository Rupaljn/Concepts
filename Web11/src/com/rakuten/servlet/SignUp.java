...
out.print("<html>");
	...
	out.print("<form action = 'SignUpController'>");
	out.print("<h3> Full Name </h3>");
	out.print("<input name = 'fullName' type = 'text'>");
	out.print("<br>");
	out.print("<h3> Email Id </h3>");
	out.print("<input name = 'emailId' type = 'text'>");
	out.print("<br>");
	out.print("<h3> ContactNumber </h3>");
	out.print("<input name = 'contactNumber' type = 'number'>");
	out.print("<br>");
